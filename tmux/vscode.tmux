...
set -g message-style "fg=#D4D4D4,bg=#121314"
set -g message-command-style "fg=#D4D4D4,bg=#121314"
...
set -g status-style "fg=#D4D4D4,bg=#121314"
...
set -g status-left "#[fg=#D4D4D4,bg=#121314,nobold] #S"
set -g status-right "#[fg=#D4D4D4,bg=#121314] #{prefix_highlight} #h"
...
setw -g window-status-current-format "#[fg=#D4D4D4,bg=#121314,nobold,nounderscore,noitalics]  #I:#W #F"
